  ...
  fun toRotationMatrixBundle(sensorEvent: SensorEvent): Bundle {
    ...
    val rotationMatrixBundle = bundleOf().apply {
      putBundle("rotationMatrix", bundleOf().apply {
        ...
        putDouble("m12", rotationMatrixOutput[1].toDouble())
        putDouble("m13", rotationMatrixOutput[2].toDouble())

        putDouble("m21", rotationMatrixOutput[4].toDouble())
        putDouble("m22", rotationMatrixOutput[5].toDouble())
        putDouble("m23", rotationMatrixOutput[6].toDouble())

        putDouble("m31", rotationMatrixOutput[8].toDouble())
        putDouble("m32", rotationMatrixOutput[9].toDouble())
